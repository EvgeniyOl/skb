         ...
         <div class="row">
            ...
            <div class="col-sm-3 mt-4">
               <div class="card w-250 h-100 d-flex justify-content-center">
                     ...
                     <div class={styles.cardbody}>
                        <Nav.Link href="/Partners/Code">"Код Безопасности"</Nav.Link>
                     </div>
               </div>
            </div>
            <div class="col-sm-3 mt-4">
               <div class="card w-250 h-100 d-flex justify-content-center">
                     ...
                     <div class={styles.cardbody}>
                        <Nav.Link href="/Partners/Cbi">"ЦБИ-сервис"</Nav.Link>
                     </div>
               </div>
            </div>
            <div class="col-sm-3 mt-4">
            ...
            <div class="col-sm-3 mt-4">
               <div class="card w-250 h-100 d-flex justify-content-center">
                     ...
                     <div class={styles.cardbody}>
                        <Nav.Link href="/Partners/Okb">"ОКБ САПР"</Nav.Link>
                     </div>
               </div>
            </div>
            <div class="col-sm-3 mt-4">
               <div class="card w-250 h-100 d-flex justify-content-center">
                     ...
                     <div class={styles.cardbody}>
                        <Nav.Link href="/Partners/Activsoft">"Актив-софт"</Nav.Link>
                     </div>
               </div>
            </div>
            <div class="col-sm-3 mt-4">
               <div class="card w-250 h-100 d-flex justify-content-center">
                     ...
                     <div class={styles.cardbody}>
                        <Nav.Link href="/Partners/Gasinformservice">"Газинформсервис"</Nav.Link>
                     </div>
               </div>
            </div>
            <div class="col-sm-3 mt-4">
               <div class="card w-250 h-100 d-flex justify-content-center">
                     ...
                     <div class={styles.cardbody}>
                        <Nav.Link href="/Partners/Trukonf">"Труконф"</Nav.Link>
                     </div>
               </div>
            </div>
            <div class="col-sm-3 mt-4">
